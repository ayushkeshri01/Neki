      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/5 via-background to-background p-4 font-sans">
        <Card className="w-full max-w-md shadow-xl border-primary/10">
          <CardHeader className="text-center space-y-6 pb-4">
            <Link href="/" className="mx-auto block w-fit group">
              <div className="mx-auto relative h-20 w-20 overflow-hidden rounded-[22px] shadow-premium-lg border border-primary/10 bg-white p-1 transition-all duration-300 group-hover:scale-105 group-hover:shadow-premium-xl group-hover:border-primary/20 cursor-pointer">
