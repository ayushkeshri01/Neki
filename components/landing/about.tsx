      ...
      <div className="max-w-container-max mx-auto flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
        ...
        >
          <motion.h2 
            ...
            viewport={{ once: true }}
            className="font-display text-3xl sm:text-4xl lg:text-5xl font-bold mb-6 lg:mb-8"
          >
            About Neki
          </motion.h2>
          ...
          <motion.p 
            ...
            className="text-sm lg:text-base text-muted-foreground mb-8 lg:mb-10 leading-relaxed"
          >
